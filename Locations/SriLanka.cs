namespace EcoQuest
{
    public class SriLanka : Location
    {
        ...
        public void CreateRooms()
        {
            ...
            new List<string> { "talk", "east", "north", "sail" },
            NPCs.Garry
            );
            ...
            Room? srilanka_beach = new("Polluted Beach",
             ...
             new List<string> { "talk", "pick", "inventory" },
             null
            );
            ...
            new List<string> { "talk", "reputation", "back", "east" },
            NPCs.Lanka
            );
            ...
            Room? srilanka_recycling_station = new("Recycling Station",
             ...
             new List<string> { "look", "talk", "dump", "sort", "reputation", "back", "south" },
             NPCs.Larry
            );
