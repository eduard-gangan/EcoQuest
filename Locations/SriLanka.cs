        ...
        public void CreateRooms()
        {
            ...
            new NPC("Gary",
                ...
                [
                    new Dialogue
                    ([
                        new Option(PlayerReply.GARY_NAME, NpcReply.GARY_NAME),
                        new Option(PlayerReply.GARY_DEAL, NpcReply.GARY_DEAL, OptionType.GARY_ADD_OPTION),
                        new Option(PlayerReply.BYE, NpcReply.BYE, OptionType.CLOSE_DIALOGUE)
            ...
            new NPC("Larry",
                NpcReply.LARRY_GREETING,
                [
                    new Dialogue
                    ([
                        new Option(PlayerReply.LARRY_NAME, NpcReply.LARRY_NAME),
                        new Option(PlayerReply.LARRY_BACKSTORY, NpcReply.LARRY_BACKSTORY),
                        new Option(PlayerReply.LARRY_PLAYER,NpcReply.LARRY_PLAYER),
                        new Option(PlayerReply.LARRY_BYE, NpcReply.LARRY_BYE, OptionType.CLOSE_DIALOGUE)
