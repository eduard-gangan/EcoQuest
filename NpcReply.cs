...
public static class NpcReply
{
    ...
    public const string GARRY_QUEST = "GARRY: Thank you. Take this trash bag and you should go to the beach and start cleaning.\nRemember, the amount of trash that you can pick is currently limited.\nIncrease your reputation, so you can acess better equipment, tools, and hopefully influence others.\nAlso, watch your energy, the human body is limited to do a certain amount of things.\nMake sure to come baack at the port and rest.\n\nYou have learned command 'sleep'\nYou have learned command 'energy'\nYou have learned command 'pick'\n\nYou can come back to the Port to replenish your energy by typing command 'sleep'";
    ...
    public const string LANKA_BYE = ">LANKA: Come back here next time, if you’ve done what i ask you to do.\n\n\nYou have learned command 'reputation'\nYou can now check you reputation.\nType 'reputation' to check your reputation.";
