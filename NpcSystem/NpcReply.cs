...
{
    //Gary
    public const string GARRY_GREETING1 = "Hello, stranger... I was waiting for someone like you to arrive.";
    public const string GARRY_GREETING2 = "Hey, you again! Keep up the good work!";
    public const string GARRY_GREETING3 = "Thank you so much for everything you've done! We are forever grateful.";
    ...
    public const string LANKA_GREETING = "The mayor taps his fingers on the table as you approach. \nLet me guess, you are the marine biologist.";
    public const string LANKA_GREETING2 = "Hey there, you've been doing a good job.";
    ...
    public const string LANKA_BYE2 = ">LANKA: Bye, you have truly proven yourself, thank you.";
    ...
    public const string LARRY_GREETING2 = "Thank you for your help. The Recycling Station has been running smoothly.";
    ...
    public const string LARRY_BYE2 = ">LARRY: Bye, you've really made a difference here. Thank you!";
    ...
    public const string ANDREW_BYE2 = ">ANDREW: Bye.";
